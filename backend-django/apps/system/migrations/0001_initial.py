...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['timestamp'], name='system_logs_timestamp_idx'),
        ),
        migrations.AddIndex(
            model_name='systemlog',
        ...
        migrations.AddIndex(
            model_name='systemlog',
            index=models.Index(fields=['category'], name='system_logs_category_idx'),
        ),
        migrations.AddIndex(
            model_name='systemlog',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['endpoint'], name='api_usage_logs_endpoint_idx'),
        ),
        migrations.AddIndex(
            model_name='apiusagelog',
            index=models.Index(fields=['timestamp'], name='api_usage_logs_timestamp_idx'),
        ),
        migrations.AddIndex(
            model_name='apiusagelog',
            index=models.Index(fields=['user'], name='api_usage_logs_user_idx'),
        ),
        migrations.AddIndex(
            model_name='apiusagelog',
            index=models.Index(fields=['status_code'], name='api_usage_logs_status_code_idx'),
        ),
    ]