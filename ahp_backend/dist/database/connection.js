...
exports.createSampleNewsData = createSampleNewsData;
exports.createSampleSupportData = createSampleSupportData;
...
const pool = databaseUrl ? new pg_1.Pool({
...
exports.query = query = pool ? (text, params) => pool.query(text, params) :
    async () => {
        console.warn('Database query attempted but DATABASE_URL not configured');
        throw new Error('Database not configured');
    };
exports.initDatabase = initDatabase = async () => {
    if (!pool) {
