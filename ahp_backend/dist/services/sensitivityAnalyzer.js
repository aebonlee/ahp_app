...
exports.SensitivityAnalyzer = void 0;
class SensitivityAnalyzer {
     ...
     * @returns 민감도 분석 결과
     */
    static performRealTimeSensitivity(input) {
        ...
        // 8. 임계값 분석
        const criticalThresholds = this.findCriticalThresholds(criteriaHierarchy, alternativeScores, targetCriterionId);
        return {
            baselineRanking,
            adjustedRanking,
            rankChanges,
     ...
     * @returns 조정된 계층구조
     */
    static applyWeightAdjustments(hierarchy, adjustments) {
     ...
     */
    static recalculateGlobalWeights(hierarchy) {
        const globalWeights = new Map();
        const calculateRecursive = (node, parentGlobalWeight = 1.0) => {
     ...
     * @returns 재계산된 대안 점수
     */
    static recalculateAlternativeScores(originalScores, newGlobalWeights) {
     ...
     * @returns 순위 변화 목록
     */
    static analyzeRankChanges(baseline, adjusted) {
     ...
     */
    static calculateStabilityIndex(rankChanges) {
     ...
     * @returns 임계값 목록
     */
    static findCriticalThresholds(hierarchy, alternativeScores, targetCriterionId) {
        const thresholds = [];
     ...
     */
    static calculateRankingThreshold(alt1, alt2, criterionId) {
     ...
     * @returns 시각화 데이터
     */
    static generateVisualizationData(criterionId, alternatives, weightRange = [0, 1], steps = 21) {
...
exports.SensitivityAnalyzer = SensitivityAnalyzer;
exports.default = SensitivityAnalyzer;
