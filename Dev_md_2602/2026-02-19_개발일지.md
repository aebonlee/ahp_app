...
### 재검증 필요 항목 (Render 배포 후)
- PATCH `/comparisons/{id}/` → 200 확인
- POST `/analysis/calculate/individual/` → AHP 가중치 결과 확인
- GET `/analysis/project-summary/` → 요약 확인
- GET `/accounts/me/` → 사용자 정보 확인
